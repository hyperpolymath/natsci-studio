...
// Replace natsci-studio, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= natsci-studio — Quick Start for Users
:toc:
:toclevels: 2

== What is natsci-studio?
...
[source,bash]
----
just install --portable --prefix=./natsci-studio-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/natsci-studio/wiki
